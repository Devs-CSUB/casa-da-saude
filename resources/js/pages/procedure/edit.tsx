...
export default function ProcedureEdit({ categories, procedure }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Editar Procedimento" />

            <div className="px-4 py-6">
                <Heading title="Editar Procedimento" description="Atualize os dados do procedimento" />
